...
public:
	...
	void PaintDisplayList(RenderSurface *surf, bool item_highlight = false, bool showFootpads = false, unsigned int mapChunkSize = 0);
...
private:
	bool PaintSortItem(RenderSurface *surf, SortItem *si, bool showFootpad, unsigned int mapChunkSize);
};
